...
garbage = pd.read_csv('./data/ごみ排出量.csv',encoding='shift_jis')
west_garbage = pd.read_csv('./data/ごみ排出量＿西日本.csv',encoding='shift_jis')
east_garbage = pd.read_csv('./data/ごみ排出量＿東日本.csv',encoding='shift_jis')
lat_lon= pd.read_csv('./data/緯度_経度.csv',encoding='shift_jis')
